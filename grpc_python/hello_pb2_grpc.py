...
def add_BehaviorServicer_to_server(servicer, server):
    rpc_method_handlers = {
...
class Behavior(object):
    ...
    def Hello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Behavior/Hello',
